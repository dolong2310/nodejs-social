...
import { FriendshipMapper } from '@/modules/friend/infrastructure/mappers/friendship.mapper.js';
import { HashtagRepository } from '@/modules/hashtag/infrastructure/mongo/hashtag.impl.repository.js';
import { HashtagMapper } from '@/modules/hashtag/infrastructure/mappers/hashtag.mapper.js';
import { PostRepository } from '@/modules/post/infrastructure/mongo/post.impl.repository.js';
import { PostMapper } from '@/modules/post/infrastructure/mappers/post.mapper.js';
import { RoleRepository } from '@/modules/role/infrastructure/mongo/role.impl.repository.js';
import { RoleMapper } from '@/modules/role/infrastructure/mappers/role.mapper.js';
import { UserRepository } from '@/modules/user/infrastructure/mongo/user.impl.repository.js';
import { UserMapper } from '@/modules/user/infrastructure/mappers/user.mapper.js';
