import type { UserMetadata } from '@/modules/user/domain/value-objects/user-metadata.value-object';
...
export interface IUserUpdatedDE extends OmitProperties<
  Partial<UserProps>,
  'provider' | 'roles' | 'status' | 'metadata'
> {}
