...
import { FriendshipFullProps } from '@/modules/friend/domain/entities/friendship.type';
import { FriendshipModel, friendshipSchema } from '@/modules/friend/infrastructure/postgres/friendship.model';
