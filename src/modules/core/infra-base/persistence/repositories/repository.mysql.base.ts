...
// import type { Paginated, PaginatedQueryParams, RepositoryPort } from 'modules/core/domain-base/repo/repository.port';
...
//     const result = await this.db.insertInto(this.tableName).values(record).executeTakeFirstOrThrow();
