...
export const GuestCannotAccessNonPublicPostException = new Error('Unauthorized');
export const OnlyOwnerCanViewPostsException = new Error('Only owner can view posts');
export const CannotViewPostBlockedException = new Error(
  'You cannot view this post because of a block between you and the author'
);
