...
} from '@/modules/post/application/use-cases/get-guest-new-feeds/get-guest-new-feeds.in-port';

export class GetGuestNewFeedsInteractor extends GetGuestNewFeedsInPort {
