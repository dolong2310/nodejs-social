...
import { MarkNotificationsReadBodyDTO } from '@/dtos/requests/notification.request.dto';
...
class NotificationsController extends BaseController implements INotificationsController {
