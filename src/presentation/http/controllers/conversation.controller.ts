import { CreateGroupInPort } from '@/application/use-cases/conversation/create-group/create-group.in-port';
import { GetConversationDetailInPort } from '@/application/use-cases/conversation/get-conversation-detail/get-conversation-detail.in-port';
import { GetConversationsInPort } from '@/application/use-cases/conversation/get-conversations/get-conversations.in-port';
import { GetOrCreateConversationInPort } from '@/application/use-cases/conversation/get-or-create-conversation/get-or-create-conversation.in-port';
import { InviteMemberInPort } from '@/application/use-cases/conversation/invite-member/invite-member.in-port';
import { KickMemberInPort } from '@/application/use-cases/conversation/kick-member/kick-member.in-port';
import { LeaveConversationInPort } from '@/application/use-cases/conversation/leave-conversation/leave-conversation.in-port';
import { TransferAdminInPort } from '@/application/use-cases/conversation/transfer-admin/transfer-admin.in-port';
import { UpdateConversationInPort } from '@/application/use-cases/conversation/update-conversation/update-conversation.in-port';
import { UpdateMemberRoleInPort } from '@/application/use-cases/conversation/update-member-role/update-member-role.in-port';
...
} from '@/presentation/http/dtos/conversation/conversation.request.dto';
import {
  ConversationDetailResponseDTO,
  ConversationResponseDTO
} from '@/presentation/http/dtos/conversation/conversation.response.dto';
