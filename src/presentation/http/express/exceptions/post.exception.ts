...
export const PostNotFoundException = new NotFoundException(VALIDATION_ERROR_MESSAGE.POST_NOT_FOUND);
export const PostContentMustBeEmptyStringException = new BadRequestException(
...
export const ParentIdMustBeNullException = new BadRequestException(VALIDATION_ERROR_MESSAGE.PARENT_ID_MUST_BE_NULL);
export const HashtagsMustBeArrayOfStringsException = new BadRequestException(
...
export const OnlyFriendsCanViewPostsException = new ForbiddenException(
  VALIDATION_ERROR_MESSAGE.ONLY_FRIENDS_CAN_VIEW_POSTS
);
export const CannotViewPostBlockedException = new ForbiddenException(VALIDATION_ERROR_MESSAGE.CANNOT_VIEW_POST_BLOCKED);
