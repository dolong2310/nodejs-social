...
export const VALIDATION_ERROR_MESSAGE = {
  ...
  POST_CONTENT_OR_MEDIA_REQUIRED: 'Post content or media is required',
  ...
  REPOST_HASHTAGS_MUST_BE_EMPTY: 'Repost hashtags must be empty',
  ...
  REPOST_MENTIONS_MUST_BE_EMPTY: 'Repost mentions must be empty',
  ...
  MEDIA_MUST_BE_EMPTY_FOR_THIS_POST_TYPE: 'Media must be empty for this post type',
