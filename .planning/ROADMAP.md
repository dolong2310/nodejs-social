...
**Plans:** 1/4 plans complete (execute order: 02-01 → 02-02 → 02-03 → 02-04; waves 1–4). *Note:* Success criterion **#5** (hide posts when blocked) is enforced end-to-end in **Phase 3** feed/read paths; Phase 2 delivers block data + `BlockRepository` helpers (BLCK-02) per `02-CONTEXT.md` D-16.
